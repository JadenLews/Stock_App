...
from .forms import UserRegistrationForm  # Make sure this form is importing from your forms.py
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            stock, created = Stock.objects.get_or_create(
                symbol=stock_symbol,
                defaults={'company_name': stock_info.info['longName'], 
...
def user_watchlist(request):
    ...
    # Pass the watchlist data to the template
    context = {
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            portfolio_item, created = Portfolio.objects.get_or_create(
                user=request.user,
                stock=stock,
                defaults={'num_shares': 0}  # Default to 0 shares
            )
