...
urlpatterns = [
    ...
    path("home/<str:time_frame>/", user_views.home, name='home'),
    ...
    path('stock/<str:symbol>/', user_views.stock_details, name='stock_details'),  # Default to 1 month
    path('stock/<str:symbol>/<str:time_frame>/', user_views.stock_details, name='stock_details_with_time_frame'),  # With time frame
